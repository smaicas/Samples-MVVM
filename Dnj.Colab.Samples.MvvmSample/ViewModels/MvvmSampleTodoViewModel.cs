...
using Dnj.Colab.Samples.MvvmSample.ViewModels.Abstractions;

namespace Dnj.Colab.Samples.MvvmSample.ViewModels;

public class MvvmSampleTodoViewModel : DnjTodoViewModel
{
}